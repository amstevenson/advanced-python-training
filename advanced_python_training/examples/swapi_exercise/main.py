...
from advanced_python_training.examples.swapi_exercise.logger import logger
from advanced_python_training.examples.swapi_exercise.swapi.category_thread import CategoryThread
